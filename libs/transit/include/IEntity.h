...
class IEntity {
  ...
  */
  ...
  /**
   * @brief Gets the distance traveled by the entity.
   * @return The distance traveled by the entity.
   */
  double getDistanceTraveled();

  /**
   * @brief Sets the distance traveled by the entity.
   * @param distance The distance traveled by the entity.
   */
